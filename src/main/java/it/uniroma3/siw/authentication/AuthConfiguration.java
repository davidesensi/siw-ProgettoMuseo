...
/**
 * AuthConfiguration è una configurazione di Spring Security
 * Estende WebSecurityConfigurerAdapter, fornisce le impostazioni per la Web security.
 */
@Configuration
@EnableWebSecurity
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/index", "/fragments/**", "/login", "/register","/artisti", "/artista/**", "/collezioni", "/collezione/**", 
                						"/opere", "/opera/**", "/informazioni", "/css/**", "/images/**").permitAll()
